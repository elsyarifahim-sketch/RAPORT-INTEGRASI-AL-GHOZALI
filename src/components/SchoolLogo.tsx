...
export const SchoolLogo: React.FC<SchoolLogoProps> = ({ className = '', size = 85 }) => {
  return (
    <svg
      width={size}
      height={size * 1.025}
    ...
    >
      <defs>
        ...
        <radialGradient id="officialPentagonGlow" cx="50%" cy="30%" r="75%">
        ...
        {/* Ribbon gradient */}
        <linearGradient id="officialRibbonGrad" x1="0%" y1="0%" x2="0%" y2="100%">
      ...
      <circle cx="100" cy="114" r="5" fill="url(#goldKnob)" stroke="#0f592f" strokeWidth="1" />
      ...
      <g>
        <rect x="92" y="137" width="16" height="7.5" rx="3.75" fill="url(#goldKnob)" stroke="#0f592f" strokeWidth="1" />
        <circle cx="95" cy="140.75" r="3.2" fill="url(#goldKnob)" stroke="#0f592f" strokeWidth="0.8" />
        <circle cx="105" cy="140.75" r="3.2" fill="url(#goldKnob)" stroke="#0f592f" strokeWidth="0.8" />
      ...
      <g>
        <rect x="90" y="157" width="5.5" height="9" rx="2.5" fill="url(#goldKnob)" stroke="#0f592f" strokeWidth="0.9" />
        <rect x="91.5" y="159" width="2.5" height="5" rx="1.2" fill="#d5f0a8" />

        <rect x="97" y="157" width="6" height="9" rx="2.5" fill="url(#goldKnob)" stroke="#0f592f" strokeWidth="0.9" />
        <rect x="98.5" y="159" width="3" height="5" rx="1.2" fill="#d5f0a8" />

        <rect x="104.5" y="157" width="5.5" height="9" rx="2.5" fill="url(#goldKnob)" stroke="#0f592f" strokeWidth="0.9" />
      ...
      <text fill="#0f592f" fontWeight="900" fontSize="9.5" letterSpacing="0.8" fontFamily="'Arial Black', 'Trebuchet MS', sans-serif">
        <textPath href="#officialBannerTextPathApp" startOffset="50%" textAnchor="middle">
          YPI AL-GHOZALI
        </textPath>
      </text>
    </svg>
