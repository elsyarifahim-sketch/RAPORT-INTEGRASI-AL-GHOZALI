  ...
  return (
    <div className="w-full mt-2 text-stone-900 select-none">
      ...
      <div 
        ...
        className={`text-center mb-2 ${onOpenDateSettings ? 'cursor-pointer hover:opacity-80 transition group' : ''}`}
        title={onOpenDateSettings ? 'Klik untuk mengubah tanggal penetapan raport' : undefined}
      >
        <p
          className="text-xs md:text-sm font-bold font-arabic text-stone-900 leading-tight"
          style={{ fontFamily: "'Amiri', 'Scheherazade New', serif", letterSpacing: 'normal' }}
          dir="rtl"
        >
          {config.dateTextAr}
        </p>
        {config.dateMasehi && (
          <p className="text-[10.5px] font-sans font-medium text-stone-600 mt-0.5 tracking-tight" dir="ltr">
      ...
      <div className="w-full px-2">
        ...
        <div className="flex justify-between items-start text-center mb-2.5">
          {/* Wali Santri */}
          <div className="flex-1 max-w-[260px] flex flex-col items-center">
            <span
              className="font-bold text-sm md:text-base font-arabic mb-7"
        ...
        <div className="flex flex-col items-center justify-center text-center relative z-20 pb-0.5">
          <span
            className="font-bold text-sm md:text-base font-arabic mb-7"
            style={{ fontFamily: "'Amiri', serif", letterSpacing: 'normal' }}
            dir="rtl"
